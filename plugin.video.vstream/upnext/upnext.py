...
from upnext.statichelper import from_unicode
from upnext.utils import get_setting, localize, localize_time
...
class UpNext(WindowXMLDialog):
    ...
    def onInit(self):  # pylint: disable=invalid-name
        ...
        if bool(get_setting('stopAfterClose') == 'true'):
            self.getControl(3013).setLabel(localize(29986))  # Stop
        else:
            self.getControl(3013).setLabel(localize(30409))  # Close
